-- ============================================================
-- CastConnect — 0000 base schema (migration baseline)
-- The core tables/functions/policies the app started with. Migrations
-- 0001–0011 build the onboarding, portfolio, and dashboard features on top,
-- so `supabase db reset` can rebuild the whole schema from scratch
-- (0000 → 0011 → seed.sql). Already applied on the live project.
-- ============================================================
